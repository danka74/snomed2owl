...
# ***  EXAMPLE COMMAND FOR RUNNING THE SCRIPT: >perl tls2_StatedRelationshipsToOwlKRSS_INT_20150131.pl OWLF .
#
#
...
$nevergrouped{"704321009"} = "T";    # | Characterizes (attribute) |
$nevergrouped{"246093002"} = "T";    # | Component (attribute) | problematic as it is grouped in the procedure model but not for observables
$nevergrouped{"704327008"} = "T";    # | Direct site (attribute) |
$nevergrouped{"704319004"} = "T";    # | Inheres in (attribute) |
$nevergrouped{"704647008"} = "T";    # | Is about (attribute) |
$nevergrouped{"704347000"} = "T";    # | Observes (attribute) |
$nevergrouped{"704326004"} = "T";    # | Precondition (attribute) |
$nevergrouped{"704322002"} = "T";    # | Process agent (attribute) |
$nevergrouped{"704323007"} = "T";    # | Process duration (attribute) |
$nevergrouped{"704324001"} = "T";    # | Process output (attribute) |
$nevergrouped{"704318007"} = "T";    # | Property type (attribute) |
$nevergrouped{"704325000"} = "T";    # | Relative to (attribute) |
$nevergrouped{"370132008"} = "T";    # | Scale type (attribute) |
$nevergrouped{"704346009"} = "T";    # | Specified by (attribute) |
$nevergrouped{"246501002"} = "T";    # | Technique (attribute) |
$nevergrouped{"246514001"} = "T";    # | Units (attribute) |
